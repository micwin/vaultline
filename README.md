...
8. Install shell completion with `source <(vaultline completion bash)` or `source <(vaultline completion zsh)`. Completion is dynamic for configured stores, binds, and allow rules.
