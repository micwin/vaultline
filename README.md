...
4. Inspect stored keys with `go run ./cmd/vaultline --addr 127.0.0.1:8428 secrets list` (add `--output json` for machine-readable output). You can use `vaultline secrets set/get/delete` as aliases for the `secret` command group.
